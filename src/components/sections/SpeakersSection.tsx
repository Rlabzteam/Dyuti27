      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
          ...
          {voices.map((voice) => (
            <div key={voice.number} className="w-full h-full relative">
              ...
              <ClipPathWrapper
                ...
                hoverEffect="scale"
                className="hd-card hd-card-light hd-card-light-hover transition-all duration-300"
              >
                <div className="p-8 sm:p-10 flex flex-col justify-between h-full min-h-[340px] text-slate-900 relative z-10">
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200">
                      ...
                      <div className="flex items-center gap-4">
                        {voice.badge && (
                          <span className="text-[10px] font-sans font-black uppercase tracking-[0.14em] text-[#071A33] bg-[#071A33]/10 px-3 py-1 rounded-full border border-[#071A33]/20 hd-chip">
                            {voice.badge}
                          </span>
                        )}
                        ...
                        <div className="w-11 h-11 shrink-0">
                          <ClipPathWrapper shape="hexagon" hoverEffect="none" className="bg-gradient-to-br from-[#071A33] via-[#12345B] to-[#040E1C] shadow-md">
                    ...
                    {/* Name */}
                    <h3 className="font-heading text-[1.45rem] sm:text-[1.65rem] font-black text-slate-950 leading-snug mb-2 hover:text-[#2563EB] transition-colors">
                      {voice.name}
                    </h3>
                  ...
                  {/* Deliberation Scope */}
                  <div className="bg-[#F8F8F6] border border-slate-200/80 rounded-xl p-4.5 hd-card shadow-xs">
                    <span className="text-[10.5px] font-mono uppercase tracking-[0.16em] text-[#071A33] font-black block mb-1">
                      Academic Focus &amp; Scope
                    </span>
                    <p className="text-[13px] text-slate-800 font-sans leading-relaxed m-0 font-medium">
                      {voice.focus}
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-12 sm:mt-16 relative w-full overflow-hidden">
          ...
          <ClipPathWrapper
            ...
            className="hd-card hd-card-light hd-card-light-hover"
          >
            <div className="p-8 sm:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
              ...
              <div className="flex items-start sm:items-center gap-5 z-10">
                <div className="w-12 h-12 rounded-xl bg-[#071A33]/10 text-[#071A33] flex items-center justify-center shrink-0 border border-[#071A33]/20 shadow-xs">
              ...
              <div className="shrink-0 z-10 w-full md:w-auto">
                <Link to="/call-for-papers" className="w-full md:w-auto">
                  <ClipPathWrapper shape="parallelogram" hoverEffect="scale" className="bg-[#071A33] hover:bg-[#12345B] transition-colors py-3 px-6 text-white font-heading font-black uppercase tracking-wider text-xs flex items-center justify-center gap-1.5 shadow-lg shadow-[#071A33]/20">
