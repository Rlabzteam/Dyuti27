...
export const TopHeaderBanner: React.FC = () => {
  return (
    <div className="w-full bg-white border-b border-slate-200/90 shadow-sm relative z-40">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-2 sm:py-2.5 flex items-center justify-between gap-2 sm:gap-4 md:gap-6">
