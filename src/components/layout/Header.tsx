    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pointer-events-auto">
        ...
        >
          ...
          <div className="h-[64px] sm:h-[74px] px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4 text-white">
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              >
                {/* Circular White Badge housing Logo (Exact icswhmh.com style) */}
                <div className="h-11 w-11 sm:h-13 sm:w-13 rounded-full bg-white p-1 shadow-md flex items-center justify-center shrink-0 transition-transform duration-200 group-hover:scale-105 border border-slate-200">
                  <img
            ...
            {/* Right: White Pill Register Button (Exact icswhmh.com style) */}
