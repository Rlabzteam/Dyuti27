...
export const AnnouncementBar: React.FC = () => {
  return (
    <div className="w-full max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-1.5 relative z-50">
      <aside
        className="bg-[#071A33] text-white rounded-xl sm:rounded-full border border-white/15 shadow-md overflow-hidden"
        aria-label="Conference Announcement"
      >
        <div className="px-4 sm:px-6 h-10 sm:h-9 flex items-center justify-between gap-6 font-sans">
          {/* Left: Label + message */}
