  ...
  committee: {
    executiveCommittee: {
      chiefPatron: {
        ...
        imageUrl: '/images/team/dr_fr_saju_md_cmi.png',
      } as CommitteeMember,
      patron: {
    ...
    conveners: [
      ...
      },
      {
        ...
        institution: 'Rajagiri College of Social Sciences (Autonomous)',
        email: 'dyuti@rajagiri.edu',
        imageUrl: '/images/team/dr_sr_bincy_cc.png',
      },
    ] as CommitteeMember[],
    organizingCommittee: [
      { name: 'Dr. Anish K.R.', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_anish_kr.png' },
      { name: 'Dr. Sunirose I.P.', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_sunirose_ip.png' },
      { name: 'Dr. Nycil Romis Thomas', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_nycil_romis_thomas.png' },
      { name: 'Dr. Shinto Thomas CMI', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_shinto_thomas_cmi.png' },
      { name: 'Dr. Rajeev S.P.', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_rajeev_sp.png' },
      ...
      { name: 'Sr. Shyba S Babu', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/sr_shyba_s_babu.png' },
      { name: 'Dr. Reena Merin Cherian', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_reena_merin_cherian.png' },
      { name: 'Dr. Lorane Scaria', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_lorane_scaria.png' },
      { name: 'Dr. Shilpa V. Yohannan', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_shilpa_v_yohannan.jpg' },
      { name: 'Mr. Danishwar Rasool Dar', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_danishwar_rasool_dar.png' },
      ...
      { name: 'Dr. Josephine Nongmaithem', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_josephine_nongmaithem.png' },
    ] as CommitteeMember[],
