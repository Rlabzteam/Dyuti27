...
export const CONFERENCE_DATA = {
  ...
  committee: {
    ...
    organizingCommittee: [
      ...
      { name: 'Dr. Danishwar Rasool Dar', designation: 'Organizing Committee Member', department: 'Department of Social Work', institution: 'Rajagiri College of Social Sciences (Autonomous)', imageUrl: '/images/team/dr_danishwar_rasool_dar.png' },
